...
export default memo(function DayForecast({ forecast, units, index }: DayForecastProps) {
  ...
  return (
    ...
    <div key={index} className="bg-white min-w-[250px] h-[320px] p-2 flex flex-col gap-[5px] justify-between rounded-lg shadow-lg text-center text-charcoal">
      <p data-testid={`forecast-date-${index}`} className="text-md font-medium text-left">
