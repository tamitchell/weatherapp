...
interface WeatherSummaryProps {
  ...
  export default function WeatherSummary({cityName, mainTemp, feelsLike, description, units}: WeatherSummaryProps): JSX.Element {
    return (
        <div className="text-charcoal">
          <p className="text-lg mb-4" data-testid="city-name">{cityName}</p>
          <div className="text-center mb-6 text-black flex flex-col gap-2">
            <MainTemperatureDisplay className="text-[clamp(2rem,8vw,4rem)] text-black font-bold" temp={mainTemp} units={units} />
