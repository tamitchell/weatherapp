...
export default function LeftPanelErrorState(): JSX.Element {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-background-secondary p-4 text-center text-foreground">
      ...
      <div className="bg-background p-6 rounded-lg p-4 mb-4">
      ...
      <button
        className="bg-black text-primary-foreground px-4 py-2 rounded hover-gradient transition-colors flex items-center text-foreground"
